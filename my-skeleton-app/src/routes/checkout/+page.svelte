...
<div class="flex flex-row place-content-center">
	<div class="p-2 flex flex-row flex-wrap gap-5 md:w-9/12">
		<div id="basket" class="flex flex-col p-2 gap-2 w-full md:w-7/12">
			<div class="h3">Basket</div>
			<Basket {basketItems} {basketPriceString} />
		</div>

		<div id="customerDetails" class="flex flex-col p-2 gap-2 w-full md:w-4/12">
			...
			<form class="customerDetails" action="creditcard">
				<div class="flex flex-col grow-0 gap-y-3 w-70">
					...
					<a href="/creditcard" class="btn variant-filled mt-2" data-sveltekit-preload-data="hover"
